...
.PHONY: 1.22
1.22:
	$(MAKE) k8s kubernetes_version=1.21.4 kubernetes_build_date=2021-09-09 pull_cni_from_github=true
	
.PHONY: 1.23
1.23:
	$(MAKE) k8s kubernetes_version=1.22.7 kubernetes_build_date=2022-04-05 pull_cni_from_github=true
